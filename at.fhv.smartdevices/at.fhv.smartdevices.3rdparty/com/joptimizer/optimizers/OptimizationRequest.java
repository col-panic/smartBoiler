...
public class OptimizationRequest {
	...
	boolean isCheckProgressConditions() {
	...
	boolean isCheckKKTSolutionAccuracy() {
	...
	ConvexMultivariateRealFunction getF0() {
		return f0;
	}
	...
	DoubleMatrix1D getInitialPoint() {
		return initialPoint;
	}
	...
	DoubleMatrix1D getNotFeasibleInitialPoint() {
	...
	DoubleMatrix1D getInitialLagrangian() {
	...
	ConvexMultivariateRealFunction[] getFi() {
		return fi;
	}
