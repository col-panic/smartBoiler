...
/**
 * This function represents the logarithm of a posynomial after a change of
 * variables x->y=log(x). <br>
...
public class LogTransformedPosynomial implements ConvexMultivariateRealFunction {
	 ...
	 * 
	 * @param akArray
	 *            the matrix (a[1,k],..,a[n,k]) in expression (2)
	 * @param bkArray
	 *            the vector b[k] in expression (2)
	 */
