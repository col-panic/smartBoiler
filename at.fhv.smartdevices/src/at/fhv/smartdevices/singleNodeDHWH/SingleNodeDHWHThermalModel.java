...
public class SingleNodeDHWHThermalModel {
	...
	private static final double tempMax = 90.0d;// [°C] max allowed temperature in
												// water heater;
	 ...
	 * @param temp_1 resulting temperature (°C)
	 * @param temp_0 intial temperature (°C)
	 * @param u relais state (0/1)
	 * @param deltat time step size (ms)
