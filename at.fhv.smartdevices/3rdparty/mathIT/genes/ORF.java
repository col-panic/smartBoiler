...
public class ORF implements java.io.Serializable {
    ...
    */
   public static String getFrequencyAsHTMLGraph(ArrayList<ORF> genes) {
    ...
    *  @return the entropy of the frequency distribution of this gene
    */
   public static double entropy(ArrayList<ORF> genes) {
      TreeMap<Codon, Double> frequency = computeFrequency(genes);
      double h = 0, p;
      for (Codon c : Codon.values()) {
