...
/**
 * Generalized logarithm barrier function for SOCP with constraints: <br>
 * ||Ai.x+bi|| < ci.x+di, i=1,...,m
 * 
...
public class SOCPLogarithmicBarrier implements BarrierFunction {
	 ...
	 * class for the constraints: <br>
	 * ||Ai.x+bi|| < ci.x+di+t, i=1,...,m
	 * 
	 ...
	 * 
	 * @param param
	 *            SOCPConstraintParameters instance
	 * @param X
	 *            evaluation point
	 * @return t = c.x + d
	 */
	...
	/**
	 * The definition of a socp inequality constraint in the form of: <br/>
	 * ||A.x+b|| < c.x+d
	 * 
	 */
